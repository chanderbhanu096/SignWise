...
- That applies to anything the contract creates, not only to its clauses: a side agreement, a promise, a notice, a penalty. Write what the contract provides, not what follows in law. WRONG: "Mündliche Nebenabreden sind unwirksam." / "Verbal promises are void." RIGHT: "Der Vertrag sieht mündliche Nebenabreden nicht vor." / "The contract does not provide for verbal side agreements."
