...
const EN: Strings = {
  ...
  uploadTime: "Up to 12 pages",
  dragText: "Drop your contract here",
  fileTypes: "PDF, JPG, PNG or WebP · max. 4 MB · PDF up to 12 pages",
  uploadBtn: "Choose contract file",
  privacy:
    "Readable PDF text is sent to Azure OpenAI with common identifiers masked. Photos and scanned PDF pages are sent as images, including any visible personal details. Only upload documents you’re allowed to share.",
  ...
  analyzingSub: "Larger or scanned contracts may take longer. Keep this page open; you can cancel at any time.",
  ...
  originalSub: "Read the extracted contract wording. Select a marked section to see its explanation. Compare with your file if anything looks incomplete.",
  backToSummary: "← Back to summary",
  explanationLabel: "Explanation",
  selectFinding: "Select a finding",
  selectHint: "Select any section of the contract on the left, or one of the findings below, and it is explained here in plain language.",
  ...
  lawScope: (n) => `${n} comparisons are available for this contract type. Only recognised provisions can be compared.`,
  lawLimit:
  ...
  lawEmptyTitle: "No comparison triggered",
  lawEmptyBody: (n) =>
    `This prototype supports ${n} comparisons for this contract type, but none was triggered by the recognised wording. Missing information or different phrasing can prevent a match. This is not confirmation that your contract meets these rules.`,
  ...
  legalNoticeSections: [
    {
      heading: "What SignWise is and what it is not",
      items: [
        ...
        { term: "It does not advise.", text: "SignWise explains wording and provides general information. It cannot determine whether a clause is valid in your case or whether you should sign. For an individual assessment, contact a qualified legal adviser." },
        ...
        { term: "Checking the sources.", text: "Quoted passages are matched against extracted PDF text when available. A matching quote does not prove that its explanation is correct. Images and scans cannot be checked independently this way. Legal links use a bundled index of official statutes; a link confirms the source exists in that index, not that it applies to your case." },
      ],
    },
    {
      heading: "How this prototype handles your document",
      items: [
        { term: "Purpose.", text: "To produce the analysis, translations and answers you request." },
        { term: "What is sent.", text: "PDFs are opened in your browser. Readable text is sent for analysis. If a page lacks readable text, all pages are rendered and sent as images. Uploaded photos are also sent as images. Filenames stay in your browser." },
        { term: "Masking personal details.", text: "Common identifiers such as bank details, email addresses and phone numbers in text are replaced with placeholders before sending and restored in your browser. Pattern matching can miss personal information. Visible details in images and scans are not masked. Only upload documents you are allowed to share." },
        { term: "Processing service.", text: "Requests pass through the SignWise server to the configured Microsoft Azure OpenAI service. Processing location and provider retention depend on that deployment and cannot be verified from this page." },
        { term: "Storage.", text: "This app does not save a document history or analysis database. The active analysis stays in memory until you start over, reload or close the tab. This does not describe retention by the hosting or model provider. Check the deployment operator’s privacy information before sharing sensitive documents." },
      ],
    },
    {
  ...
  errorTitle: "We couldn’t analyse this contract",
...
const DE: Strings = {
  ...
  uploadTime: "Bis zu 12 Seiten",
  dragText: "Vertrag hier ablegen",
  fileTypes: "PDF, JPG, PNG oder WebP · max. 4 MB · PDF bis 12 Seiten",
  uploadBtn: "Vertragsdatei auswählen",
  privacy:
    "Lesbarer PDF-Text wird mit maskierten üblichen Identifikatoren an Azure OpenAI gesendet. Fotos und gescannte PDF-Seiten werden als Bilder gesendet, einschließlich sichtbarer persönlicher Daten. Laden Sie nur Dokumente hoch, die Sie teilen dürfen.",
  ...
  analyzingSub: "Längere oder gescannte Verträge können mehr Zeit benötigen. Lassen Sie diese Seite geöffnet; Sie können jederzeit abbrechen.",
  ...
  originalSub: "Lesen Sie den ausgelesenen Vertragstext. Wählen Sie einen markierten Abschnitt für seine Erklärung. Vergleichen Sie mit Ihrer Datei, falls etwas unvollständig erscheint.",
  backToSummary: "← Zurück zur Zusammenfassung",
  explanationLabel: "Erklärung",
  selectFinding: "Einen Punkt auswählen",
  selectHint: "Wählen Sie links einen beliebigen Paragrafen des Vertrags oder unten einen der Punkte — die Erklärung erscheint hier in einfacher Sprache.",
  ...
  lawScope: (n) => `Für diesen Vertragstyp sind ${n} Vergleiche verfügbar. Nur erkannte Regelungen können abgeglichen werden.`,
  lawLimit:
  ...
  lawEmptyTitle: "Kein Vergleich ausgelöst",
  lawEmptyBody: (n) =>
    `Dieser Prototyp unterstützt ${n} Vergleiche für diesen Vertragstyp. Der erkannte Wortlaut hat keinen davon ausgelöst. Fehlende Angaben oder andere Formulierungen können einen Abgleich verhindern. Das bestätigt nicht, dass Ihr Vertrag diesen Regeln entspricht.`,
  ...
  legalNoticeSections: [
    {
      ...
      items: [
        ...
        { term: "Quellen prüfen.", text: "Zitate werden mit ausgelesenem PDF-Text abgeglichen, soweit dieser vorliegt. Ein passendes Zitat beweist nicht, dass seine Erklärung richtig ist. Bilder und Scans können so nicht unabhängig geprüft werden. Gesetzeslinks verwenden ein mitgeliefertes Verzeichnis amtlicher Gesetze; ein Link bestätigt weder Aktualität noch Anwendbarkeit im Einzelfall." },
      ],
    },
    {
      heading: "Wie dieser Prototyp Ihr Dokument verarbeitet",
      items: [
        { term: "Zweck.", text: "Die von Ihnen angeforderte Analyse, Übersetzung und Beantwortung von Fragen." },
        { term: "Was gesendet wird.", text: "PDFs werden in Ihrem Browser geöffnet. Lesbarer Text wird zur Analyse gesendet. Fehlt auf einer Seite lesbarer Text, werden alle Seiten als Bilder gesendet. Hochgeladene Fotos werden ebenfalls als Bilder gesendet. Dateinamen bleiben im Browser." },
        { term: "Persönliche Daten maskieren.", text: "Übliche Identifikatoren wie Bankverbindungen, E-Mail-Adressen und Telefonnummern im Text werden vor dem Senden durch Platzhalter ersetzt und im Browser wiederhergestellt. Die Mustererkennung kann persönliche Daten übersehen. Sichtbare Daten in Bildern und Scans werden nicht maskiert. Laden Sie nur Dokumente hoch, die Sie teilen dürfen." },
        { term: "Verarbeitender Dienst.", text: "Anfragen laufen über den SignWise-Server zum eingerichteten Microsoft-Azure-OpenAI-Dienst. Verarbeitungsort und Aufbewahrung beim Anbieter hängen von der Bereitstellung ab und lassen sich auf dieser Seite nicht überprüfen." },
        { term: "Speicherung.", text: "Die App legt keinen Dokumentverlauf und keine Analysedatenbank an. Die aktive Analyse bleibt im Arbeitsspeicher, bis Sie neu beginnen, die Seite neu laden oder schließen. Dies beschreibt nicht die Aufbewahrung beim Hosting- oder Modellanbieter. Prüfen Sie die Datenschutzhinweise des Betreibers, bevor Sie sensible Dokumente teilen." },
      ],
    },
    {
  ...
  errorTitle: "Dieser Vertrag konnte nicht analysiert werden",
