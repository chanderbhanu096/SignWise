...
const EN: Strings = {
  ...
  originalSub: "Your contract in full. Every section is explained — select one to read it in plain language. The coloured ones are those that deserve the most attention.",
...
const DE: Strings = {
  ...
  originalSub: "Ihr Vertrag vollständig. Jeder Paragraf wird erklärt — wählen Sie einen aus, um ihn in einfacher Sprache zu lesen. Farbig sind die, die die meiste Aufmerksamkeit verdienen.",
